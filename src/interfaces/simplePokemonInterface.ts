...
export class Convert {
  public static toPok(json: string): Pok {
    return cast(JSON.parse(json), r('Pok'));
  }

  public static pokToJson(value: Pok): string {
    return JSON.stringify(uncast(value, r('Pok')), null, 2);
  }
}
